...
(function($) {
	"use strict";
		...
		//Image Background 
		$(".image-background").backstretch("images/background_ver3.jpg");
		...
		$('#clock-countdown').countdown('2018/12/30 12:00:00').on('update.countdown', function(event) {
			var $this = $(this).html(event.strftime(''
				+ '<div class="counter-container"><div class="counter-box first"><div class="number">%-D</div><span>Dienas</span></div>'
				+ '<div class="counter-box"><div class="number">%H</div><span>Stundas</span></div>'
				+ '<div class="counter-box"><div class="number">%M</div><span>Minūtes</span></div>'
				+ '<div class="counter-box last"><div class="number">%S</div><span>Sekundes</span></div></div>'
			));
		});
